## Pattern search with case_sensitivity

# Adding case_sensitive parameter into pattern_search function
def pattern_search(text, pattern, case_sensitive = True):
    for index in range(len(text)):
        match_count = 0

        # conditional statements accounting for case_sensitivity
